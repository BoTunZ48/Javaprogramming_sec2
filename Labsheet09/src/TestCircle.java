...
public class TestCircle {
	...
	public static void main(String[] args) {
		...
		System.out.println(c1); //call to String() Method c1.toString()
		System.out.println();
		...
		Circle c3 = new Circle(1.0); //1st (default Constructor)
		...
		System.out.printf("The cicumference is: %.3f",c1.getCircumference());
